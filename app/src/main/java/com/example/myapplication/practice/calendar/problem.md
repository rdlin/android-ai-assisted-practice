...
Starter code is already included in the project. It renders a seeded day schedule, includes a small time-range model, and has a route wired through the practice launcher. Your task is to extend the baseline into a real scheduling feature.

## Starter Code Available

- Route: `PracticeRoute.CalendarPlanner`
